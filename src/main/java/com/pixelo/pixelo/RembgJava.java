...
public class RembgJava {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try (OrtEnvironment env = OrtEnvironment.getEnvironment();
            ...
            BufferedImage finalImage = applyAlphaMask(resized, reshapedMask);
    ...
    public static BufferedImage resizeTo320x320(BufferedImage originalImage) {
    ...
    public static float[] convertImageToTensor(BufferedImage image) {
    ...
    public static BufferedImage applyAlphaMask(BufferedImage image, float[][] mask) {
        int width = image.getWidth();
        int height = image.getHeight();
